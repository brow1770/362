...
void makeClockFace(void) {
    //set up clkface, numbers, and directions
    char* alarmDir = "Press A to set alarm, then A to confirm";
    char* AMDir = "Press B to set AM";
    char* PMDir = "Press C to set PM";
    char* cancelDir = "Group 48 loves Rick and GTA Rahul.";
    LCD_Clear(BLACK); //background
    LCD_Circle(120,160,120,1, BLUE); //clock frame
    LCD_Circle(120,160,115,1, WHITE); //clock face
    LCD_DrawChar(112,50,BLACK,WHITE,49,16,0); //1 for 12
    LCD_DrawChar(121,50,BLACK,WHITE,50,16,0); //2 for 12
    LCD_Circle(170,73,2,1,BLACK); //dot for 1
    LCD_Circle(208,110,2,1,BLACK); //dot for 2
    LCD_Circle(208,212,2,1,BLACK); //dot for 4
    LCD_Circle(170,248,2,1,BLACK); //dot for 5
    LCD_Circle(31,212,2,1,BLACK); //dot for 8
    LCD_Circle(69,248,2,1,BLACK); //dot for 7
    LCD_Circle(69,73,2,1,BLACK); //dot for 11
    LCD_Circle(31,110,2,1,BLACK); //dot for 10
    LCD_DrawChar(117,255,BLACK,WHITE,54,16,0); //6
    LCD_DrawChar(220,153,BLACK,WHITE,51,16,0); //3
    LCD_DrawChar(15,153,BLACK,WHITE,57,16,0); //9
    LCD_DrawString(5,5,WHITE,BLACK,alarmDir,12,0); //alarm directions
    LCD_DrawString(20,295,WHITE,BLACK,cancelDir,12,0); //cancel directions
    LCD_DrawString(5,20,WHITE,BLACK,AMDir,12,0); //AM directions
    LCD_DrawString(130,20,WHITE,BLACK,PMDir,12,0); //PM directions
}

void makeAlarmFace(void) {
    LCD_Clear(RED); //background
    char* alarmNotif = "Oh no :(";
    LCD_DrawString(120,80,WHITE,RED,alarmNotif,16,0); //words
    LCD_DrawLine(5,30,60,45,WHITE);
    LCD_DrawLine(5,60,60,45,WHITE);
    LCD_DrawLine(35,39,35,53,WHITE); //A
    LCD_DrawLine(5,70,60,70,WHITE);
    LCD_DrawLine(5,70,5,90,WHITE); //L
    LCD_DrawLine(5,100,60,115,WHITE);
    LCD_DrawLine(5,130,60,115,WHITE);
    LCD_DrawLine(35,109,35,123,WHITE); //A
    LCD_DrawLine(5,140,60,140,WHITE);
    LCD_DrawLine(60,140,60,160,WHITE);
    LCD_DrawLine(60,160,55,170,WHITE);
    LCD_DrawLine(40,170,55,170,WHITE);
    LCD_DrawLine(35,160,40,170,WHITE);
    LCD_DrawLine(35,140,35,160,WHITE);
    LCD_DrawLine(35,140,5,170,WHITE); //R
    LCD_DrawLine(5,180,60,180,WHITE);
    LCD_DrawLine(60,180,5,195,WHITE);
    LCD_DrawLine(5,195,60,210,WHITE);
    LCD_DrawLine(5,210,60,210,WHITE); //M
    LCD_DrawLine(25,220,60,220,WHITE);
    LCD_DrawLine(5,220,15,220,WHITE); //!
    LCD_Circle(150,160,60,0,WHITE); //face outline
    LCD_Circle(150,180,10,0,WHITE); //mouth
    LCD_DrawLine(130,160,130,140,WHITE); //eyes
    LCD_DrawLine(170,160,170,140,WHITE); //eyes
    char* stopD1 = "Press D";
    char* stopD2 = "to turn";
    char* stopD3 = "off alarm";
    LCD_DrawString(5,240,WHITE,RED,stopD1,16,0); //stop  message
    LCD_DrawString(5,260,WHITE,RED,stopD2,16,0); //stop  message
    LCD_DrawString(5,280,WHITE,RED,stopD3,16,0); //stop  message
}
